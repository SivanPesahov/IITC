...
import { DetailedSpecification } from './ui/DetailedSpecification'

export const Details = () => {
  return (
    <div className='md:mt-52'>
      <div>
        <h1 className='text-center md:text-start mt-24 mb-16 text-5xl px-20'>We're different</h1>
      </div>

      <div className='md:flex md:justify-evenly px-20'>
        <div className='p-6'>
          <div className='flex justify-center text-center md:flex md:justify-start md:pb-6'>
          ...
          <h2 className='text-center mb-4 md:flex md:justify-start font-bold text-2xl'>snappy Process</h2>
          <p className='text-center mb-8 md:text-start'>Our application process can be completed in minutes, not hours. Don’t get 
        ...
        <div className='p-6'>
          ...
          <h2 className='text-center mb-4 md:flex md:justify-start font-bold text-2xl'>affordable Proces</h2>
          <p className='text-center mb-8 md:text-start'> We don’t want you worrying about high monthly costs. Our prices may be low, 
        ...
        <div className='p-6'>
          ...
          <h2 className='text-center mb-4 md:flex md:justify-start font-bold text-2xl'>people First</h2>
          <p className='text-center mb-8 md:text-start'>Our plans aren’t full of conditions and clauses to prevent payouts. We make 
