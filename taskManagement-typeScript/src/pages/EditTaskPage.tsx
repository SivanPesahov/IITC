...
import { ITodo } from "./CreateTaskPage";
...
export const EditTaskPage = () => {
  ...
  async function handleAdding(
    ...
    ev.preventDefault();
    const [...arr] = task.todoList;
    const newTodo: ITodo = { title: todoRef.current!.value, isComplete: false };
    arr.push(newTodo);
    const { data } = await api.patch("task/edit/" + taskId, {
      todoList: arr,
    });
  ...
  async function handleActivate(id: string, isComplete: boolean) {
